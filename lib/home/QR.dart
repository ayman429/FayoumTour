    ...
    return Scaffold(
      ...
      body: Center(
        child: QrImageView(
          ...
          eyeStyle:  QrEyeStyle(color: Theme.of(context).colorScheme.onPrimary,eyeShape: QrEyeShape.square),
          dataModuleStyle:  QrDataModuleStyle(color: Theme.of(context).colorScheme.onPrimary,dataModuleShape: QrDataModuleShape.square),
        ),
      ),
    );
  }
