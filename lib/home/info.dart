...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('About FayTour',
        style: TextStyle(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("Allow us to elucidate that this application was conceived as the graduation project at the Faculty of Computer Science. "
              ...
              Text("Unquestionably, our ardent aspiration was to invigorate the realm of tourism in this enchanting region. "
                ...
                child: Row(
                  ...
                  children: const [
                    CircleAvatar(
                            ...
                            SizedBox(width: 5,),
                            Expanded(child: Text("Fayoum Governorate Administration",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold))),
                  ],
                ),
              ),
                    ...
                    child: Row(
                      ...
                      children:  const [
                        CircleAvatar(
                                ...
                                SizedBox(width: 5,),
                                Expanded(child: Text("Dr. Moataz",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold))),
                      ],
                    ),
                  ),
                    ...
                    child: Row(
                      ...
                      children:  const [
                        CircleAvatar(
                                ...
                                SizedBox(width: 5,),
                                Expanded(child: Text("Dr. Mohammed Kamal",style: TextStyle(fontSize: 13,fontWeight: FontWeight.bold))),
                      ],
                    ),
                  ),
                ],
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children:  [
                    const CircleAvatar(
                              backgroundImage:
                                  AssetImage('assets/images/slama.jpg'),
                              radius: 30,
                            ),
                            ...
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: const [
                                  Text("Dr. Ahmed Slama",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
                                  Text("Doctor at the Faculty of Computers and Artificial Intelligence, Fayoum University",style: TextStyle(fontSize: 12,color: Colors.grey)),
                                ],
                              ),
                            ),
                  ],
              ...
              Column(
                ...
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                        const url = "https://www.facebook.com/profile.php?id=100004426397969";
                  if (await canLaunch(url)) {
                    await launch(url);
                  } else {
                    throw 'Could not launch $url';
                          ...
                          const CircleAvatar(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  ...
                                  Text("Ayman Mansour",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                        const url = "https://www.facebook.com/marwanyasser632001/";
                  if (await canLaunch(url)) {
                    await launch(url);
                  } else {
                    throw 'Could not launch $url';
                        ...
                        children:   [
                          const CircleAvatar(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  Text("Eng.",style: TextStyle(fontSize: 14),),
                                  Text("Marwan Yasser",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
                ...
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                        const url = "https://www.facebook.com/profile.php?id=100010258625338";
                  if (await canLaunch(url)) {
                    await launch(url);
                  } else {
                    throw 'Could not launch $url';
                        ...
                        children:   [
                          const CircleAvatar(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  Text("Eng.",style: TextStyle(fontSize: 14),),
                                  Text("Mahmoud Hamdy",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                  const url = "https://www.facebook.com/profile.php?id=100010453833581";
                  if (await canLaunch(url)) {
                    await launch(url);
                  } else {
                    throw 'Could not launch $url';
                        ...
                        children:   [
                          const CircleAvatar(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  Text("Eng.",style: TextStyle(fontSize: 14),),
                                  Text("Hamada Mostafa",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
                ...
                children: [
                        ...
                        children:   [
                          const CircleAvatar(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: const [
                                  Text("Eng.",style: TextStyle(fontSize: 13),),
                                  Text("Ahmed Abdelaltawab",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () async{
                  const url = "https://www.facebook.com/profile.php?id=100011939985594";
                  if (await canLaunch(url)) {
                    await launch(url);
                  } else {
                    throw 'Could not launch $url';
                        ...
                        children:   [
                          const CircleAvatar(
                              ...
                              child: Column(
                                ...
                                children: const [
                                  Text("Eng.",style: TextStyle(fontSize: 14),),
                                  Text("Mohammed Ramadan",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ),
                        ],
