...
class HotelReservationScreen extends StatefulWidget {
  const HotelReservationScreen({Key? key}) : super(key: key);
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          final date = await showDatePicker(
                            ...
                            lastDate: _checkOutDate.subtract(const Duration(days: 1)),
                          );
                          if (date != null) {
                            setState(() {
                              _checkInDate = date;
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: GoogleFonts.acme(fontSize: 22.0,color: Colors.green),
                              ),
                            ],
                          ),
                        ),
