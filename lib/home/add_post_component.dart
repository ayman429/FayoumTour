        ...
        builder: (context, state) {
          return Scaffold(
            appBar: AppBar(
              ...
              actions: [
                Opacity(
                  opacity: _textEditingController.text == "" && _imageList.isEmpty ? 0.5
                  : widget.type == 'add' ? 1 : _textEditingController.text == widget.data.body && _imageList.isEmpty ? 0.5 : 1,
                  child: Container(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            child:  Icon(Icons.cancel,color: Theme.of(context).colorScheme.onPrimary,)),
                                        ],
                                      )
                                    ],
                                  ),
